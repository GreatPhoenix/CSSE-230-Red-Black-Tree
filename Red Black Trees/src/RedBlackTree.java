...
public class RedBlackTree<T extends Comparable<? super T>> implements Iterable<RedBlackTree.BinaryNode> {
	...
	private void rightRotationHandler(BinaryNode currentNode) {
		...
		//if (currentNode.rightChild.leftChild != null && currentNode.rightChild.rightChild != null && currentNode.rightChild.leftChild.leftChild != null){
...
//		}
	...
	private void leftRotationHandler(BinaryNode currentNode) {
		...
		//if (currentNode.leftChild.rightChild != null && currentNode.leftChild.leftChild != null && currentNode.leftChild.rightChild.rightChild != null){
...
//						return insertHelper(currentNode.leftChild, value,currentNode,currentNode);
//					}
//					
